...
6. 「完了」ボタンを押すとステータスが切り替わり、必要に応じて進捗も自動補完
...
![パスワード再発行画面](static/image/password_reset_form.png)

### 12. パスワード再発行メール送信完了画面

![パスワード再発行メール送信完了画面](static/image/password_reset_done.png)

### 13. パスワード再設定画面

![パスワード再設定画面](static/image/password_reset_confirm.png)
